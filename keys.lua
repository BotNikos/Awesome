...
local keys = gears.table.join (
   ...
   awful.key({modkey}, "space", kblayout.toggle, {description = "Change layout", group = "applications"}
   ),
   ...
   awful.key({ modkey, }, "=", function () volumeMeter.change ("increase") end, {description = "Increase volume by 10", group = "multimedia"}),
   awful.key({ modkey, }, "-", function () volumeMeter.change ("decrease") end, {description = "Decrease volume by 10", group = "multimedia"})
)
