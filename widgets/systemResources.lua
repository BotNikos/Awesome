...
local cpu = wibox.widget {
   {
      ...
      {
         {
            image = os.getenv ("HOME") .. "/.config/awesome/icons/feather_white/cpu.svg",
...
local ram = wibox.widget {

   {
      {
         {
            image = os.getenv ("HOME") .. "/.config/awesome/icons/feather_white/database.svg",
...
local disc =  wibox.widget {
   {
      {
         {
            image = os.getenv ("HOME") .. "/.config/awesome/icons/feather_white/hard-drive.svg",
