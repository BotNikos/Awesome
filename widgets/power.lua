...
local reboot = wibox.widget {
   {
      {
         image = os.getenv ("HOME") .. "/.config/awesome/icons/feather_white/rotate-ccw.svg",
         forced_width = 50,
         forced_height = 50,
         halign = "center",
...
local logout = wibox.widget {
   {
      {
         image = os.getenv ("HOME") .. "/.config/awesome/icons/feather_white/log-out.svg",
         forced_width = 50,
         forced_height = 50,
         halign = "center",
         widget = wibox.widget.imagebox
...
local shutdown = wibox.widget {
   {
      {
         image = os.getenv ("HOME") .. "/.config/awesome/icons/feather_white/power.svg",
         forced_width = 50,
         forced_height = 50,
         halign = "center",
         widget = wibox.widget.imagebox
