...
theme.font = "Mononoki Nerd Font Bold 14"
...
-- theme.taglist_shape_border_color_focus = violet
-- theme.taglist_shape_border_color = background
-- theme.taglist_bg_focus = background
theme.taglist_fg_focus = foreground 
...
-- theme.wibar_fg = "#ff0000"
-- theme.wibar_bg = "#BD93F9"
-- theme.wibar_border_width = 5

-- Tasklist settings
theme.tasklist_disable_icon = true 
theme.tasklist_bg_focus = background
theme.tasklist_spacing = 100
